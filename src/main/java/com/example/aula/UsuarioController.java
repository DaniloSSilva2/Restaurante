...
public class PratoController {
    ...
    public ResponseEntity<Map<String, Object>> salvar(@Valid @RequestBody Prato prato) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(Map.of("mensagem", "Prato cadastrado com sucesso."));
    }

    @PutMapping
    public ResponseEntity<Map<String, Object>> atualizar(@Valid @RequestBody Prato prato) {
        pratoService.atualizar(prato);
        return ResponseEntity.ok(Map.of("mensagem", "Prato atualizado com sucesso."));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<Map<String, Object>> excluir(@PathVariable Long id) {
        pratoService.excluir(id);
        return ResponseEntity.ok(Map.of("mensagem", "Prato excluído com sucesso."));
    }
}
